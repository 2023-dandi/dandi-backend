...
public class InternalServerException extends RuntimeException {
    ...
    private static final String WITHDRAWN_MEMBER_POST_EXCEPTION_MESSAGE_FORMAT =
            "탈퇴한 회원(memberId : %d)의 게시글(postId : %d)이 조회되었습니다.";
    ...
    public static InternalServerException withdrawnMemberPost(Long memberId, Long postId) {
        String exceptionMessage = String.format(WITHDRAWN_MEMBER_POST_EXCEPTION_MESSAGE_FORMAT, memberId, postId);
        return new InternalServerException(exceptionMessage);
    }
}
