...
class PostReportCommandServiceAdapterTest {
    ...
    void reportPost_NotFound() {
        ...
        assertThatThrownBy(() -> postReportCommandServiceAdapter.reportPost(MEMBER_ID, POST_ID))
    ...
    void reportPost() {
        ...
        postReportCommandServiceAdapter.reportPost(MEMBER_ID, POST_ID);
