...
@SpringBootTest(classes = {WeatherBatch.class, WeatherPersistenceAdapter.class, WeatherBatchTestConfig.class, DatabaseCleaner.class})
class WeatherBatchTest {
    ...
    void weatherBatchJob() throws Exception {
        ...
        JobParameters jobParameters = new JobParameters(Map.of("dateTime", new JobParameter(now.toString()), "backOffPeriod", new JobParameter(1L)));
    ...
    void weatherBatchJob_RetryableException_Success() throws Exception {
        ...
        JobParameters jobParameters = new JobParameters(Map.of("dateTime", new JobParameter(dateTime.toString()), "backOffPeriod", new JobParameter(1L)));
        EntityManager entityManager = entityManagerFactory.createEntityManager();
        entityManager.getTransaction().begin();
        entityManager.persist(new WeatherLocationJpaEntity(null, 110, 100, "서울특별시", null, null));
        entityManager.getTransaction().commit();
