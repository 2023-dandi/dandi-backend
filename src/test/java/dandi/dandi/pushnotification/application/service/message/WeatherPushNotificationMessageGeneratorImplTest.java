...
class WeatherPushNotificationMessageGeneratorImplTest {
    ...
    void generateMessage(WeatherForecastResponse weatherForecastResponse, String expectedMessage) {
    ...
    private static Stream<Arguments> provideWeatherForecastResponseAndExpectedMessage() {
        return Stream.of(
                Arguments.of(WeatherForecastResponse.ofSuccess(10, 20),
                        "오늘 날씨는 최저 10 / 최고 20입니다. 단디에서 옷차림을 확인해보세요"),
                Arguments.of(WeatherForecastResponse.ofSuccessButLocationUpdate(10, 20),
                        "오늘 날씨는 최저 10 / 최고 20입니다. 위치 정보를 수정해서 날씨 정확도를 높여주세요!"),
                Arguments.of(WeatherForecastResponse.ofFailure("DB_ERROR", true),
