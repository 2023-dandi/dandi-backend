...
class NotificationQueryServiceAdapterTest {

    @Mock
    private NotificationPersistencePort notificationPersistencePort;
    @InjectMocks
    private NotificationQueryServiceAdapter notificationQueryServiceAdapter;
    ...
    void getNotifications() {
        ...
        NotificationResponses actual =
                notificationQueryServiceAdapter.getNotifications(MEMBER_ID, CREATED_AT_DESC_TEST_SIZE_PAGEABLE);
